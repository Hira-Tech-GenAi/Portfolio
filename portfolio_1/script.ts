...
const tab_links = document.getElementsByClassName(
  "tab-links"
) as HTMLCollectionOf<HTMLElement>;
const tab_contents = document.getElementsByClassName(
  "tab-contents"
) as HTMLCollectionOf<HTMLElement>;

function opentab(tab_name: string) {
...
// script code to open and close the navigation menu
const side_menu = document.getElementById("side-menu") as HTMLElement;
